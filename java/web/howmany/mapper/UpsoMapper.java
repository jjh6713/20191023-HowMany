...
public interface UpsoMapper {
	...
	//sales graph 변경
	public ArrayList<SalesVO> change_sales_graph(@Param("city_value") int city_value,@Param("upjong_value") int upjong_value,@Param("cno")int cno,@Param("uno")int uno);


	//여러 값을 넘겨줄 때는 mapper 인터페이스 부분에 각각 @Param해주어야함!!!!!!
	//Upso graph 변경
	public ArrayList<UpsoVO> change_upso_graph(@Param("city_value") int city_value,@Param("upjong_value") int upjong_value,@Param("cno")int cno,@Param("uno")int uno);


	//여러 값을 넘겨줄 때는 mapper 인터페이스 부분에 각각 @Param해주어야함!!!!!!
	//local graph 변경
	public ArrayList<Local_situationVO> change_local_situation_graph(@Param("city_value") int city_value,@Param("upjong_value") int upjong_value,@Param("cno")int cno,@Param("uno")int uno);
